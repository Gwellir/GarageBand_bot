...
from utils.migrate import fill_rows

TAG_ROWS = [
    dict(name="Другое"),
    dict(name="Двигатель/ходовая"),
    dict(name="Кузовной ремонт"),
    dict(name="Автоэлектрика"),
    dict(name="Компьютерная диагностика"),
    dict(name="Нужен совет"),
]

WRS_ROWS = [
    dict(name="welcome", processor="StartInputProcessor", buttons="{}"),
    dict(name="get_name", processor="NameInputProcessor", buttons="{}"),
    dict(name="get_request_tag", processor="TagInputProcessor", buttons="{}"),
    dict(name="get_car_type", processor="CarTypeInputProcessor", buttons="{}"),
    dict(name="get_request_desc", processor="DescriptionInputProcessor", buttons="{}"),
    dict(name="request_photos", processor="StorePhotoInputProcessor", buttons="{}"),
    dict(name="check_data", processor="SetReadyInputProcessor", buttons="{}"),
    dict(name="done", processor=None, buttons="{}"),
    dict(name="leave_feedback", processor="FeedbackInputProcessor", buttons="{}"),
    dict(name="feedback_done", processor=None, buttons="{}"),
]
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=partial(fill_rows, model_name="tgbot.Tag", rows_data=TAG_ROWS),
        ...
        migrations.RunPython(
            code=partial(fill_rows, model_name="tgbot.WorkRequestStage", rows_data=WRS_ROWS),
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.CreateModel(
            name='WorkRequest',
